- dashboard: care_variation_dc
  ...
  - title: Care Variation
    ...
    y_axes: [{label: "% of patient", orientation: bottom, series: [{axisId: No - lp_demo.number_of_patients,
            id: No - lp_demo.number_of_patients, name: 'No'}, {axisId: Yes
              - lp_demo.number_of_patients, id: Yes - lp_demo.number_of_patients,
            name: 'Yes'}], showLabels: true, showValues: false, unpinAxis: false,
  ...
  - title: Facilities
    ...
    fields: [lp_demo.facility, lp_demo.total_readmissions, lp_demo.total_unplanned_readmissions,
      lp_demo.percent_unplanned_readmit, lp_demo.average_cost_of_readmit,
      lp_demo.average_cost, lp_demo.average_length_of_stay_elective]
  ...
  - title: Top Performers/Opportunities for Improvement
    ...
    explore: lp_demo
    type: looker_grid
    fields: [lp_demo.facility, lp_demo.city, lp_demo.state_code,
      lp_demo.average_risk_adjusted_ioh_score, lp_demo.opioid_prescription_rate,
      lp_demo.mri_use_rate]
  ...
  - title: Clinician Performance
    ...
    fields: [lp_demo.average_risk_adjusted_ioh_score, lp_demo.opioid_prescription_rate,
      lp_demo.mri_use_rate, lp_demo.attending_name, lp_demo.facility,
      lp_demo.total_readmissions, lp_demo.total_payment_cost]
  ...
  - title: ''
    ...
    fields: [lp_demo.region, lp_demo.dynamic_min, lp_demo.dynamic_first_quartile,
      lp_demo.dynamic_median, lp_demo.dynamic_third_quartile,
      lp_demo.dynamic_max]
    filters: {}
  ...
  - title: Outcome Distribution by Region
    ...
    explore: lp_demo
    type: looker_bar
    fields: [lp_demo.region, patient_comorbidity_facts.number_of_patients,
      lp_demo.outcome]
    pivots: [lp_demo.region]
    filters:
      lp_demo.region: "-Regional Health Network,-Duke LifePoint Healthcare"
    sorts: [lp_demo.region, patient_comorbidity_facts.number_of_patients
        desc 0]
    limit: 50
    dynamic_fields: [{args: [lp_demo.number_of_patients], calculation_type: percent_of_row,
        ...
        label: Percent of row, source_field: lp_demo.number_of_patients,
        table_calculation: percent_of_row, value_format: !!null '', value_format_name: percent_0,
        _kind_hint: measure, _type_hint: number, is_disabled: true}, {args: [patient_comorbidity_facts.number_of_patients],
    ...
    y_axes: [{label: '', orientation: bottom, series: [{axisId: percent_of_lp_demo_number_of_patients,
            id: Central Division - percent_of_lp_demo_number_of_patients,
            name: Central Division}, {axisId: percent_of_lp_demo_number_of_patients,
            id: Eastern Division - percent_of_lp_demo_number_of_patients,
            name: Eastern Division}, {axisId: percent_of_lp_demo_number_of_patients,
            id: Mountain Division - percent_of_lp_demo_number_of_patients,
            name: Mountain Division}, {axisId: percent_of_lp_demo_number_of_patients,
            id: Western Division - percent_of_lp_demo_number_of_patients,
            name: Western Division}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear}]
  ...
  - title: New Tile
    ...
    explore: lp_demo
    type: single_value
    fields: [lp_demo.procedure_condition]
    filters:
      lp_demo.condition_param: Coronary^_Artery^_Bypass
    sorts: [lp_demo.procedure_condition]
    limit: 500
    custom_color_enabled: true
  ...
  - title: New Tile
    ...
    fields: [lp_demo.opioid_prescription_rate, lp_demo.number_of_patients_with_gaps_in_care,
      lp_demo.division]
    sorts: [lp_demo.opioid_prescription_rate desc]
    limit: 500
    hidden_fields: []
    hidden_points_if_no: []
    series_labels: {}
  ...
  - title: New Tile
    ...
    fields: [lp_demo.unplanned_readmit_reason, patient_comorbidity_facts.comorbidity,
  ...
  - title: New Tile
    ...
    explore: lp_demo
    type: looker_map
    fields: [lp_demo.facility_location, lp_demo.percent_unplanned_readmit,
      lp_demo.facility]
