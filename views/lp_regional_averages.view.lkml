...
## ---------------------------- Measures ---------------------------- ##
  ...
  measure: lp_regional_average_rate_of_complications {
    group_label: "LP Regional-Level"

    type: average
    sql: ${average_rate_of_complications} ;;
    value_format_name: decimal_2
    drill_fields: [detail*,lp_facility_averages.lp_facility_average_rate_of_complications]
  }

  measure: lp_regional_average_rate_of_serious_complications {
    group_label: "LP Regional-Level"

    type: average
    sql: ${average_rate_of_serious_complications} ;;
    value_format_name: decimal_2
    drill_fields: [detail*,lp_facility_averages.lp_facility_average_rate_of_serious_complications]
  }

  measure: lp_regional_average_readmission_post_procedure {
    group_label: "LP Regional-Level"

    type: average
    sql: ${average_readmission_post_procedure} ;;
    value_format_name: percent_1
    drill_fields: [detail*,lp_facility_averages.lp_facility_average_readmissions_post_procedure]
  }

  measure: lp_regional_total_payment_cost {
    group_label: "LP Regional-Level"
    group_item_label: "Lp Regional Total Payment/Cost"

    type: average
    sql: ${average_cost} ;;
    value_format_name: usd_0
    drill_fields: [detail*,lp_facility_averages.lp_facility_total_payment_cost]
  }

  measure: lp_regional_average_length_of_stay_elective {
    group_label: "LP Regional-Level"
    group_item_label: "Lp Regional Average Length of Stay - Elective"

    type: average
    sql: ${average_length_of_stay_elective} ;;
    value_format_name: decimal_2
    drill_fields: [detail*,lp_facility_averages.lp_facility_average_length_of_stay_elective]
  }

  measure: lp_regional_average_number_of_gaps_in_care {
    group_label: "LP Regional-Level"

    type: average
    sql: ${average_number_of_gaps_in_care} ;;
    value_format_name: decimal_2
    drill_fields: [detail*,lp_facility_averages.lp_facility_average_number_of_gaps_in_care]
  }

  measure: lp_regional_total_number_of_gaps_in_care {
    group_label: "LP Regional-Level"

    type: average
    sql: ${total_number_of_gaps_in_care} ;;
    drill_fields: [detail*,lp_facility_averages.lp_facility_total_number_of_gaps_in_care]
  }

  measure: lp_regional_average_access {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_adherence_to_testing {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_adherence_to_treatment {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_diagnosis {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_diagnostic_testing_process {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_potential_health_concern {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_problem_recognition {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_response_to_treatment {
    group_label: "LP Regional-Level"
  ...
  measure: lp_regional_average_treatment_or_recommendation_to_treatment {
    group_label: "LP Regional-Level"
...
############CQI Update##############
  measure: lp_regional_average_home_health_pt {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_home_health_pt} ;;
  }

  measure: lp_regional_average_equipment_not_there {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_equipment_not_there} ;;
  }

  measure: lp_regional_average_waiting_for_pt_referral {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_waiting_for_pt_referral} ;;
  }

  measure: lp_regional_average_tobacco_use_preop {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_tobacco_use_preop} ;;
  }

  measure: lp_regional_average_chronic_disease_exacerbation {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_chronic_disease_exacerbation} ;;
  }

  measure: lp_regional_average_orders_not_written {
    group_label: "LP Regional-Level"
    type: average
    sql: ${avg_orders_not_written} ;;
  }

  measure: lp_regional_average_rounds_not_done {
    group_label: "LP Regional-Level"
    type: average
